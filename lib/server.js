            ...
            if (error) {
                ...
                proxy.request(response, requestParams, content, function(davResponse){
                    ...
                    notifyPostRequestHandler(
                        ...
                        path[1],
                        {
                            session: response.authToken ? response.authToken.session : null,
                            fileName: file.name,
                            localPath: file.path,
...
module.exports.respond = proxy.respond;
module.exports.addRoute = function (method, expression, callback) {
    proxy.addRoute(method, expression, callback);
}
